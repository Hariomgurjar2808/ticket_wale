  ...
  const initialPassengers = useMemo(
    () =>
      Array.from({ length: seatCount }, (_, index) => ({
        seatLabel:
          seats !== "-"
            ? seats.split(",")[index]?.trim() || `${index + 1}`
            : `${index + 1}`,
        name: "",
        age: "",
      })),
    ...
    >
      <Box className="mx-auto w-full max-w-6xl">
        ...
        >
          ...
          <Typography
            variant="h3"
            sx={{ fontWeight: 800, mt: 1, mb: 1.5, fontSize: { xs: "2rem", md: "2.6rem" } }}
          >
            Add Passenger Details
          </Typography>
          <Typography
            variant="body1"
            sx={{ maxWidth: 720, opacity: 0.92, fontSize: { xs: "1rem", md: "1.05rem" } }}
          >
            Enter the name and age for each selected seat before moving to payment.
            Your trip summary is shown alongside the form for quick review.
          </Typography>
        ...
        <Box className="grid grid-cols-1 gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <Box className="space-y-6">
            ...
            >
              ...
              <Box className="space-y-3">
                ...
                <Box className="flex items-center justify-between gap-4">
                  ...
                  <Typography
                    variant="body1"
                    sx={{ fontWeight: 700, color: "#111827", textAlign: "right" }}
                  >
                    {busName}
                  </Typography>
                </Box>
            ...
            >
              ...
              >
                <Typography variant="body2" sx={{ opacity: 0.82 }}>
                  Review each passenger carefully. The payment page will open once all details
                  are completed.
                </Typography>
              </Box>
            </Box>
